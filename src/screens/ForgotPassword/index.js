        ...
        <ScrollView>
          <View>
            ...
            <Text style={styles.instructions}>
              ...
              baixo. Além disso, já insira uma nova senha, porque se a
              verificação for feita com sucesso já iremos recadastrar sua senha
            </Text>
          </View>
          ...
          <View style={styles.inputs}>
            ...
            <CustomButtons
              Label="Voltar"
              onButtonPressed={() => navigation.navigate("Login")}
            />
