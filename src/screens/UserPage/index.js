...
const UserPage = ({ navigation }) => {
    ...
    const EditHandler = () => {
        if(!user.logged){
            alert('Você não está logado, portanto não poderá alterar nenhum dado pessoal')
        } else {
    ...
    const content = (
        <View style={Style.screen}>
                    ...
                    <>
                        ...
                        <View style={Style.nameAndChangePhotoBox}>
                            ...
                            <TouchableOpacity onPress={EditHandler}>
                                {
                                    EditInfo ?
                                    <Text style={Style.changePhotoStyle}>
                                            Voltar
                                    </Text>
            ...
            <View style={{ flexDirection: "column-reverse", flex: 1 , overflow : 'hidden' , marginTop : Spacing.MainMargin}}>
                <Image
