...
const MainProducts = ({ navigation }) => {
    ...
    const [ListOfProducts, setListOfProduct] = useState(ListOfGeneral.concat(arrAddOneInLenght));// just to add one more in lenght
        ...
        isListVisualisationSelected ? (
            index === ListOfProducts.length - 1 ?
                <TouchableOpacity style={styles.loadMoreProductsContainer}>
                    <Text style={styles.loadProductsText}>
