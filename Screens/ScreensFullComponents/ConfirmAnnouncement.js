...
import { Styles } from '../ScreensStyles/ConfirmAnnouncementStyle';
...
const ConfirmAnnouncement = () => {
    ...
    const popUpMenuHandler = () => {
        setpopUpMenu(true);
        setTimeout(() => { setpopUpMenu(false) }, 10000);
    }
    ...
    const content =
        <View style={Styles.screen}>
                    ...
                    !popUpMenu ?
                        ...
                        <View style={Styles.popUpContainer}>
                            <TouchableOpacity onPress={DeleteAnnouncementHandler}>
                                <Text style={Styles.deleteAnnoucement}>
                                    Apagar
                                </Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity onPress={EditHandler}>
                                <Text style={Styles.editAnnoucement}>
                                    Editar
                                </Text>
                            </TouchableOpacity>
                        </View>
            ...
            <View style={Styles.screen}>
                ...
                <CustomButton Label='Confirmar anúncio' onButtonPressed={ConfirmAnnouncement} />
            </View>
